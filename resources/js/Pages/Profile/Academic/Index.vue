            ...
            <div class="container px-4 py-10 mx-auto">
                <form @submit.prevent="updateFunction">
                    ...
                    <div class="p-2 w-full mb-2 flex justify-between">
                        <button type="submit" class="flex text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新する</button>
                        <!-- <button class="flex text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">削除する</button> -->
                    </div>
                </form>
                <hr>
