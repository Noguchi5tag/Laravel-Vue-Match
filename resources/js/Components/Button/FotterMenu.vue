...
<template>
    <div v-if="isLoggedIn" class="z-20 py-2 shadow-tw-shadow-top bg-white fixed bottom-0 left-1/2 -translate-x-1/2 max-w-sm w-full h-auto">
        <div class="flex justify-around items-center">
            ...
            <Link as="button" href="/confirmation" class="flex flex-col items-center">
