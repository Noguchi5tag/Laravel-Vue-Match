        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('manager.dashboard')">
                                    <ApplicationLogo
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('manager.company.create')" :active="route().current('manager.company.create')">
                                    求人登録
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('manager.companylist.index')" :active="route().current('manager.companylist.index')">
                                    求人一覧
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('manager.profile.edit')"> プロフィール </DropdownLink>
                                        <DropdownLink :href="route('manager.logout')" method="post" as="button">
                                            ログアウト
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
                ...
                >
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('manager.company.create')" :active="route().current('manager.company.create')">
                            求人登録
                        </ResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('manager.profile.edit')"> プロフィール </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('manager.logout')" method="post" as="button">
                                ログアウト
                            </ResponsiveNavLink>
                        </div>
                    </div>
